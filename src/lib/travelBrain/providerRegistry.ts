...
export const PROVIDERS: ProviderCapability[] = [
  ...
  { domain: "laws", mode: "api", provider: "Official local sources", authoritative: true, status: "blocked", notes: "Needs jurisdiction-aware official-source retrieval." },
  ...
  { domain: "budget", mode: "native", provider: "Efecto Viajero Budget Engine", status: "implemented", notes: "Creates a transparent planning envelope from the user's budget; it does not invent market prices." },
  { domain: "expenses", mode: "native", provider: "Efecto Viajero Expense Ledger", status: "implemented", notes: "Aggregates explicit numeric costs observed upstream and marks coverage when incomplete." },
  ...
  { domain: "offline", mode: "native", provider: "Efecto Viajero Offline Planner", status: "implemented", notes: "Builds a deterministic offline manifest from facts already available to the brain; missing content stays pending." },
