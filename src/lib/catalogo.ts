  ...
  return [
    {
      ...
      nombre: `Central stay in ${destino.nombre}`,
      ubicacion: "centro",
      precioNoche: Math.round(base + (s % 10)),
      mascotaFriendly: destino.mascotaFriendly,
      pros: ["Walking distance to everything", "Less commuting"],
      contras: ["The most expensive of the three options"],
    },
    {
      id: `${destino.id}-aloj-afueras`,
      nombre: `Characterful stay near ${destino.nombre}`,
      ubicacion: "afueras",
      precioNoche: Math.round(base * 0.75 + (s % 6)),
      mascotaFriendly: destino.mascotaFriendly,
      pros: ["Cheaper", "Quieter"],
      contras: ["Adds ~45 min of travel per day"],
    },
    {
      id: `${destino.id}-aloj-estacion`,
      nombre: "Practical stay by the station/airport",
      ubicacion: "cerca de estación/aeropuerto",
      precioNoche: Math.round(base * 0.9 + (s % 8)),
      mascotaFriendly: destino.mascotaFriendly,
      pros: ["Easy to arrive and leave"],
      contras: ["Less atmosphere around it"],
    },
  ];
}
...
export function actividadesDe(destino: Destino): ActividadDestino[] {
  ...
  const actividades: ActividadDestino[] = [
    {
      ...
      nombre: `Stroll through the centre of ${destino.nombre}`,
      tipo: "cultura",
      categoria: "otro",
      duracionHoras: 2,
      costeEstimado: 0,
      apta: ["outdoor", "family", "quiet"],
      entorno: "exterior",
      admiteMascotas: conPerro,
      descripcion: "Wander unhurried through the most characterful streets.",
      horarioHabitual: "Any time; best in daylight.",
    },
    {
      id: `${destino.id}-act-parque`,
      nombre: `Park or green space in ${destino.nombre}`,
      tipo: "naturaleza",
      ...
      entorno: "exterior",
      admiteMascotas: conPerro,
      descripcion: "Fresh air and a breather between plans, free and no booking.",
      horarioHabitual: "Open access; usually sunrise to sunset.",
    },
    {
      ...
      apta: ["indoor", "outdoor", "family"],
      entorno: "mixto",
      admiteMascotas: false,
      descripcion: "Try the dishes the area is known for.",
      horarioHabitual: "Usual mealtimes: midday and evening.",
    },
    {
      ...
      entorno: "mixto",
      admiteMascotas: false,
      descripcion: "Taste local dishes and produce across several stops.",
      horarioHabitual: "Best mid-afternoon or evening, in several short stops.",
    },
    {
      ...
      entorno: "interior",
      admiteMascotas: false,
      descripcion: "A good option if the weather turns.",
      ...
      horarioHabitual: "Usually open morning to evening; many close one day a week.",
    },
    {
      ...
      entorno: "interior",
      admiteMascotas: false,
      descripcion: "Local listings or programme — good for an evening, or if it rains.",
      horarioHabitual: "Shows usually evening; check the day's listings.",
    },
    {
      ...
      entorno: "interior",
      admiteMascotas: false,
      descripcion: "Nightlife area recommended by locals.",
      horarioHabitual: "Usually gets going after 23:00.",
    },
    {
      ...
      entorno: "mixto",
      admiteMascotas: false,
      descripcion: "Crafts and local produce.",
      horarioHabitual: "Best in the morning; weekdays are usually quieter.",
    },
  ];
  ...
  if (destino.tags.includes("naturaleza") || destino.tags.includes("montana")) {
    actividades.push({
      ...
      nombre: `Hiking route near ${destino.nombre}`,
      tipo: "naturaleza",
      categoria: "naturaleza",
      duracionHoras: 4,
      costeEstimado: 0,
      ...
      entorno: "exterior",
      admiteMascotas: conPerro,
      descripcion: "An accessible trail with good views.",
      horarioHabitual: "Best setting off early, with daylight ahead of you.",
    });
  }
  if (destino.tags.includes("playa")) {
    actividades.push({
      ...
      entorno: "exterior",
      admiteMascotas: conPerro,
      descripcion: "Time by the sea. Many beaches restrict dogs in high season: worth checking the signs.",
      horarioHabitual: "Open access; best from mid-morning to mid-afternoon.",
    });
  }
  if (destino.tags.includes("pueblos")) {
    actividades.push({
      id: `${destino.id}-act-pueblo`,
      nombre: "Day trip to a nearby village",
      tipo: "pueblos",
      categoria: "pueblos",
      duracionHoras: 4,
      ...
      entorno: "exterior",
      admiteMascotas: conPerro,
      descripcion: "Discover a traditional village a short hop away.",
      horarioHabitual: "Ideal as a full-day trip, leaving in the morning.",
    });
  }
