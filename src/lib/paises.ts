...
const LISTA: Pais[] = [
  ...
  { codigo: "NI", nombre: "Nicaragua", moneda: "córdoba (NIO)", bloques: ["ca4"] },
  ...
  { codigo: "BZ", nombre: "Belice", emergencias: "911" },
  ...
  { codigo: "GB", nombre: "Reino Unido", alias: ["Inglaterra", "UK"], moneda: "libra esterlina (GBP)", emergencias: "999 · 112" },
